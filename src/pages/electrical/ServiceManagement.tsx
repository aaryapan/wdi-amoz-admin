...
export const ServiceManagement: React.FC = () => {
  ...
  return (
    <ElectricalLayout title="Service Management">
      <Container>
        <TopBar>
          <SearchContainer>
          ...
          <AddButton onClick={() => navigate('/electrical/services/add')}>
        ...
        {categories.map((category) => (
          <CategorySection key={category.id}>
            ...
            <CategoryContent expanded={expandedCategories.includes(category.id)}>
                  ...
                  <TableBody>
                    {category.services.map((service, index) => (
                      <TableRow key={index}>
                        ...
                        <TableCell>
                          <ViewButton onClick={() => navigate(`/electrical/services/${category.id}/${service.srNo}`)}>
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              ...
              <EditButton onClick={() => navigate(`/electrical/services/${category.id}/edit`)}>
