...
export const ManageEmployees: React.FC = () => {
  ...
  return (
    <ElectricalLayout title="Manage Employee">
      <Container>
        <TopBar>
          <SearchContainer>
          ...
          <AddButton onClick={() => navigate('/electrical/employees/add')}>
            ...
            <TableBody>
              {employees.map((employee, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell>
                    <ActionsContainer>
                      <ActionButton onClick={() => navigate(`/electrical/employees/${employee.id}/calendar`)}>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                      ...
                      <ActionButton onClick={() => navigate(`/electrical/employees/${employee.id}/logs`)}>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                          <path d="M4 6H16M4 10H16M4 14H16" stroke="#666" strokeWidth="1.5" strokeLinecap="round"/>
                        </svg>
                      </ActionButton>
                      <ActionButton onClick={() => navigate(`/electrical/employees/${employee.id}/edit`)}>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                      ...
                      <ActionButton onClick={() => navigate(`/electrical/employees/${employee.id}`)}>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
