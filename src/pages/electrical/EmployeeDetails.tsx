...
export const EmployeeDetails: React.FC = () => {
  ...
  return (
    <ElectricalLayout title="Manage Employee">
      <Container>
        <Breadcrumb>
          <BreadcrumbLink onClick={() => navigate('/electrical/employees')}>
            Manage Employee
          </BreadcrumbLink>
          <span>&gt;</span>
        ...
        <Card>
          <ProfileHeader>
            ...
            <ActionButtons>
              <ActionButton onClick={() => navigate(`/electrical/employees/${id}/logs`)}>
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <path d="M4 6H16M4 10H16M4 14H16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
                </svg>
                Service Logs
              </ActionButton>
              <ActionButton onClick={() => navigate(`/electrical/employees/${id}/calendar`)}>
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
          ...
          <EditButton onClick={() => navigate(`/electrical/employees/${id}/edit`)}>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
