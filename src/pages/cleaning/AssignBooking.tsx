...
export const AssignBooking: React.FC = () => {
  ...
  return (
    <CleaningLayout title="Assigning Booking">
      <Container>
        <LeftPanel>
          <TabsContainer>
            ...
            <Tab active={activeTab === 'previous'} onClick={() => navigate('/cleaning/assign-booking/previous')}>
              Previous Bookings
            </Tab>
          </TabsContainer>
        ...
        <RightPanel>
          ...
          <ChatButton onClick={() => navigate('/cleaning/assign-booking/chat')}>
