...
export const EmployeeDetails: React.FC = () => {
  ...
  return (
    <CleaningLayout title="Manage Employee">
      <Container>
        <Breadcrumb>
          <BreadcrumbLink onClick={() => navigate('/cleaning/employees')}>
            Manage Employee
          </BreadcrumbLink>
          <span>&gt;</span>
        ...
        <Card>
          <ProfileHeader>
            ...
            <ActionButtons>
              <ActionButton onClick={() => navigate(`/cleaning/employees/${id}/logs`)}>
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <path d="M4 6H16M4 10H16M4 14H16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
                </svg>
                Service Logs
              </ActionButton>
              <ActionButton onClick={() => navigate(`/cleaning/employees/${id}/calendar`)}>
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
          ...
          <EditButton onClick={() => navigate(`/cleaning/employees/${id}/edit`)}>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
