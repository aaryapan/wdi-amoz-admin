    ...
    <CleaningLayout title="Service Management">
      <Container>
        <TopBar>
          ...
          <AddButton onClick={() => navigate('/cleaning/services/add')}>
        ...
        {categories.map((category) => (
          <CategorySection key={category.id}>
            ...
            <CategoryContent expanded={expandedCategories.includes(category.id)}>
                  ...
                  <TableBody>
                    {category.services.map((service, index) => (
                      <TableRow key={index}>
                        ...
                        <TableCell>
                          <ViewButton onClick={() => navigate(`/cleaning/services/${category.id}/${service.srNo}`)}>
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              ...
              <EditButton onClick={() => navigate(`/cleaning/services/${category.id}/edit`)}>
